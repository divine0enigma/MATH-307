/**
 * This class will create flight arrivals.
 * 
 * Justin Arends 
...
public class Arrival extends Flight
{
     ...
     */
    public Arrival(String airline, int number, String city, int time)
    {
        super(airline, number, city, time);
    }
    
    /**
     * Adds additional arrival message to the toString() method.
     */
    public String toString(){
        String x = super.toString();
        String statement = "Arrival: " + x;
        return statement;
    }
    ...
    public boolean hasConflict(Flight otherFlight){
        ...
        if(((Math.abs(this.time/100 - otherFlight.time/100) == 1) && (this.time%100 <= 15) && (otherFlight.time%100 >=45)))
        {
